        ...
        // campo en blanco el banco no manda esos correos. Ver docs/estado.md.
        {
            ...
            recommendations: {
                items: [
                    ...
                    { label: 'Cód. Institución', html: `Para pagos a cuenta (${chip('CTA')}), ingresa el código de la institución financiera. Si ingresas ${chip('17')}, lo convertiremos automáticamente en ${chip('0017')}.<br>Para Cheque (${chip('CHQ')}) o Efectivo (${chip('EFE')}), utilizaremos ${chip('0017')} de Banco Guayaquil.<br><span class="italic text-slate-400 dark:text-white/40">¿Cuáles son los códigos de Instituciones Financieras a utilizar para archivos masivos? – Centro de Ayuda</span>` },
